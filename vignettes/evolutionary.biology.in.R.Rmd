...
## CDC model
This function implements a hidden state in one binary trait and allows users to test whether transitions in a second binary trait occur primarily right after transitions in the first.
```{r}
...
plot(tip.state.full[[2]],tip.state.full[[3]], col=c("red", "blue", "green")[tip.state.full[[1]]], pch=16, cex=.6,
     xlim=c(-4,4), ylim=c(-4,4), xlab="Liability 1", ylab="Liability 2")
