...
GetTipRates <- function(tree = NULL,
  ...
  # Q: transition matrix containing estimated rates
  # tip.states: An integer vector with a length equal to the number of species 
      #on the phylogeny. It should have values of 1 to N with N being the number of 
      #total states. Elements of the vector should match the tip names for the phylogeny. 
  ...
  #loop through to make sure the tip states supplied are correct
  if(hyper == TRUE){
